                            ...
                            <tr class="bg-white hover:bg-gray-50" id="index_{{ $overdue->id }}">
                                ...
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                    <h5 class="mb-1 text-sm font-bold tracking-tight text-gray-900">
                                        {{ $overdue->title }}</h5>
                                    <p class="mb-2 text-xs font-normal text-gray-700">{{ $overdue->comment }}</p>
                                    <div class="flex justify-start">
                                        <p class="mr-2 text-xs font-bold text-red-500">{{ $overdue->clock }} AM</p>
                                        <svg width="4" height="4" viewBox="0 0 4 4" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="2" cy="2" r="2" fill="#737373" />
                                        </svg>
                                        <p class="ml-2 text-xs font-normal text-gray-700">{{ $overdue->date }}</p>
                                    </div>
                                </th>
