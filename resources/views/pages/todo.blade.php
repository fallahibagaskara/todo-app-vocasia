    ...
    <div id="view" class="flex flex-row w-screen h-full" x-data="{ sidenav: true }">
            ...
            <div class="mt-10 space-y-6 md:space-y-10">
                ...
                <div id="menu" class="flex flex-col space-y-2">
                    <a href="{{route('todo.index')}}"
                        class="px-2 py-2 text-sm font-medium text-gray-700 transition duration-150 ease-in-out rounded-md hover:text-red-700 hover:text-base">
        ...
        <main class="w-full min-h-screen transition-all bg-white main">
            ...
            <div class="grid grid-cols-3">
                ...
                <div id="clock_date" class="relative col-span-1 m-10 overflow-x-auto border">
                    <div class="flex items-center justify-between border-b">
                        <div class="flex m-4">
