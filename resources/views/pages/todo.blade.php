    ...
    <div id="view" class="flex flex-row w-screen h-max" x-data="{ sidenav: true }">
        ...
        <main class="w-full min-h-screen transition-all bg-white main">
            ...
            <div class="grid grid-cols-3">
                ...
                <div id="todo" class="relative col-span-2 mx-10 overflow-y-auto border max-h-[550px]">
                                ...
                                <tr class="bg-white hover:bg-gray-50" id="index_{{ $todo->id }}">
                                    ...
                                    <th class="px-6 py-4 font-medium text-gray-900">
                                        ...
                                        <div class="flex items-center justify-start">
                                            <p class="mr-2 text-xs font-bold text-lightprimary">{{ \Carbon\Carbon::parse($todo->clock)->format('H:i A') }}
                                            </p>
                                    ...
                                    <td class="flex items-end justify-end px-6 py-9">
                                        <a href="javascript:void(0)" id="{{ $todo->id }}"
                                            data-modal-target="editTodoModal" data-modal-toggle="editTodoModal"
                                            data-id="{{ $todo->id }}"
                                            class="font-medium editIcon hover:underline">
