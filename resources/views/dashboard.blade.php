        ...
        <div id="sidebar"
            ...
            <div class="space-y-6 md:space-y-10 mt-10">
                ...
                <div id="menu" class="flex flex-col space-y-2">
                    ...
                    <a href=""
                        class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-gray-800 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                    ...
                    <a href=""
                        class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-gray-800 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                        {{-- CEK LAGI ICONNYA --}}
                        <svg class="w-5 h-5 fill-current inline-block" fill="currentColor" viewBox="0 0 27 27"
                            xmlns="http://www.w3.org/2000/svg">
